...
void runas(const CommandLine& cmd_line, HWND hwnd, int nShow) {
    const auto exe_path = cmd_line.has_argv0() ? cmd_line.get_argv0() : get_executable_path();
...
void runas_self(HWND hwnd, int nShow) {
